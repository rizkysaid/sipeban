	...
	<table width="100%" rules="rows">
		<tr id="title">
			<div id="judul">
				<td align="justify" colspan="5">
					...
					<p align="center">pencairan ADD <?php echo $pencairan->nama_romawi ?></p>
				...
				<table id="titi-header1">
					<tbody>
						...
						<tr>           
							...
							<td><span>:</span></td>           
							<td><span><?php echo date('d-m-Y', strtotime($pencairan->tanggal)) ?></span></td>         
						</tr>
						<tr height="10px">
							<td></td>
							<td></td>
						...
						<tr>
							...
							<td></td>
							<td></td>
							<td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Kepada</td>
						</tr>
						<tr>
							<td></td>
							<td></td>
		...
		<tr>
			<table id="isi1">
				<tbody>
					<tr>
						<td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Dipermaklumkan dengan hormat, dengan ini kami sampaikan Permohonan <?php echo $pencairan->nama_kegiatan ?> <?php echo $pencairan->nama_tahap ?> Tahun Anggaran <?php echo $thn->tahun ?>,  sesuai data sebagai berikut :</td>
					</tr>
					<tr height="5px">
						<td></td>
					</tr>
